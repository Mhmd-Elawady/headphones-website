        ...
        <Container>
          ...
          <Row className="mt-4">
            <Col xs={12} md={4} className="mb-3">
              <img src={detail1} alt="Detail 1" className="details-image" />
            </Col>
            <Col xs={12} md={4} className="mb-3">
              <img src={detail2} alt="Detail 2" className="details-image" />
            </Col>
            <Col xs={12} md={4} className="mb-3">
              <img src={detail3} alt="Detail 3" className="details-image" />
            </Col>
          </Row>
        </Container>
      </section>
